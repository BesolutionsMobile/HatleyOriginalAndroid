...
public class recent_places_adapter extends RecyclerView.Adapter<recent_places_adapter.places_holder> {

    private Context context;
    private ArrayList<saved_places_list>mylist;
    private TinyDB tinyDB;

    public recent_places_adapter(Context context, ArrayList<saved_places_list> mylist) {
