...
public class Apicalls {
    ...
    public void insertUser(final String name, final String email, final String password, final String confirm_password, final String token, final String image_id, final String phone) {

        apiRouter.performRequest(Apiclient.INSERT_USER.getURL(), Apiclient.INSERT_USER.getParams(), Arrays.asList(name, email, password, confirm_password, token, image_id, phone), Request.Method.POST, 2);
