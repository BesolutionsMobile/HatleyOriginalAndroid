...
public class Apicalls {
    ...
    public void insertUser(final String name, final String email, final String password, final String confirm_password,final  String token) {

        apiRouter.performRequest(Apiclient.INSERT_USER.getURL(),Apiclient.INSERT_USER.getParams(), Arrays.asList(name,email,password,confirm_password,token), Request.Method.POST,2);
